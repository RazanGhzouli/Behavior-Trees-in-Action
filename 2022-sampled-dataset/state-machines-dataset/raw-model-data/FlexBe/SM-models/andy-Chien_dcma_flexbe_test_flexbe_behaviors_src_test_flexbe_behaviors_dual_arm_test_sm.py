...
class DualArmTestSM(Behavior):
	...
	def __init__(self):
		super(DualArmTestSM, self).__init__()
		self.name = 'Dual Arm Test'
	...
	def create(self):
		...
		_sm_container_0 = ConcurrencyContainer(outcomes=['finished', 'failed'], conditions=[
										('finished', [('Test Behaviors', 'finished'), ('Test Behaviors 2', 'finished')]),
										('failed', [('Test Behaviors', 'failed'), ('Test Behaviors 2', 'failed')])
										])
